...
async def send_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [
            InlineKeyboardButton("اختبار مذاكرة أ.مازن", callback_data="mazin_test"),
...
async def send_startup_broadcast(application: Application):
    target_ids = [
        7054781539, 956694003, 1863051514, 7005016496, 295585493, 1093492893, 1721140136, 826136166, 916463896, 1251514174,
        1290651329, 2114756105, 5593428720, 1621074010, 588074812, 951512926, 1005642202, 1103824995, 1242498612, 1422603055,
        1467322640, 1709162918, 1751296299, 1836744446, 1358814666, 2099077296, 2107121321, 2147109884, 5690920577, 184393030,
        286378253, 343720228, 470562509, 532023471, 590543659, 613654352, 625351538, 654491682, 659622432, 661606842,
        802793876, 807893163, 810826398, 854211678, 865062378, 865763219, 884341249, 906419477, 906596196, 908936230,
        926511157, 931407078, 952275955, 971108168, 974811111, 983204763, 987063611, 1001034993, 1074607653, 1076808403,
        1146765896, 1201824716, 1254026019, 1268556528, 1272883538, 1316595299, 1360433158, 1447225185, 1484071642, 1497318928,
        1660038338, 1732892044, 1841477523, 1854980793, 1950501865, 1961162660, 1961989653, 1998163048, 2027008026, 2080753143,
        2083481538, 2091311877, 2112349644, 2121126368, 5158830317, 5184414979, 5268793099, 5279192227, 5486525127, 5796377897,
        5975703557, 6205701174, 6444455552, 6771316498, 6953982665, 6980701101, 7511852897, 7740798088, 7763207370, 7942981397,
        8050311495
    ]
    
    flag_file = "broadcast_mazen_sent.flag"
    if os.path.exists(flag_file):
        logging.info("Broadcast already sent. Skipping.")
        return

    message = "تم اضافة اختبار لمذاكرة أ.مازن"
    count = 0
    ...
    logging.info(f"Broadcast sent to {count} users.")
...
def main():
    ...
    application = Application.builder().token(TOKEN).post_init(send_startup_broadcast).build()
